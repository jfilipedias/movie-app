...
import (
	...
	gateway "github.com/jfilipedias/movie-app/movie/internal/gateway/grpc"
...
func main() {
	...
	metadataGateway := gateway.NewMetadataGrpcGateway(registry)
	ratingGateway := gateway.NewRatingGrpcGateway(registry)
